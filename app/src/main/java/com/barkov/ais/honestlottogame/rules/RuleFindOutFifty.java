...
public class RuleFindOutFifty extends Rule
{
    private int value = 0;
    public RuleFindOutFifty() {
        this.setRuleText("Guess the number in the range 1-50");
        this.setRuleType(Rule.GUES_NUMBER_OUT_OF_FIFTY);
        value = generateValue();
    }
    ...
    private int generateValue()
    {
        ...
        int value = (int)generator.nextInt((int)Math.round(50))
                + 1;
